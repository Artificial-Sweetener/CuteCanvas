...
from .geometry import object_contains, object_path
...
class VectorNodeEditController:
    ...
    def __init__(
        ...
        *,
        ...
        self._selection: QPaneVectorNodeSelectionState | None = None
        self._session: _VectorNodeSession | None = None

    @property
    def selection(self) -> QPaneVectorNodeSelectionState | None:
    ...
    def _set_node_selection(
        self,
        selection: QPaneVectorNodeSelectionState | None,
    ) -> bool:
