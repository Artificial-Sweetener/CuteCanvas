...
class MaskPixelTranslator:
    ...
    def preview_move(
        ...
        *,
        ...
        source_pixels = _region(before, patch_bounds, source_bounds).copy()
        minimum_selection = int(selection.min())
        maximum_selection = int(selection.max())
        hard_full_selection = minimum_selection == 255
        hard_selection = hard_full_selection or (
            minimum_selection == 0
            and maximum_selection == 255
    ...
    def restore(
        ...
        *,
        ...
        mask.surface.set_bounds(target_bounds)
