...
"""Focused activation ports for QPane's built-in tools."""
...
if TYPE_CHECKING:
    ...
    from ..scene.transform_geometry import TransformModifiers, TransformOperation
...
def _one() -> float:
    """Return the neutral scalar used by zoom and pressure defaults."""
    return 1.0
...
class CursorInteractionPort:
    ...
    is_image_null: Callable[[], bool] = _true
...
class NavigationInteractionPort:
    ...
    is_pan_zoom_locked: Callable[[], bool] = _true
    is_image_null: Callable[[], bool] = _true
    is_drag_out_allowed: Callable[[], bool] = _false
    ...
    set_zoom_one_to_one: Callable[[QPoint | None], None] = lambda _anchor=None: None
    set_zoom_one_to_one_interpolated: Callable[[QPoint | None], None] | None = None
...
class MoveInteractionPort:
    ...
    update_move: Callable[[QPointF], bool] = lambda _point: False
    finish_move: Callable[[QPointF], bool] = lambda _point: False
...
def tool_activation_ports(
    *,
    ...
    extension = ToolDependencies(
        ...
        is_pan_zoom_locked=navigation.is_pan_zoom_locked,
        is_image_null=navigation.is_image_null,
        ...
        update_move=movement.update_move,
        finish_move=movement.finish_move,
