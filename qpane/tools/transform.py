...
"""Photoshop-style affine transform gesture translation."""
...
class TransformTool(BaseTool):
    ...
    def keyPressEvent(self, event: QKeyEvent) -> None:
        """Resolve cumulative affine state with Photoshop's standard keys."""
    ...
    def _modifiers(modifiers: Qt.KeyboardModifier) -> TransformModifiers:
        """Map current keys onto Photoshop's affine constraint policy."""
