...
from ..scene.render_plan import SampledTileRenderData, VectorLayerRenderItem
...
from ..vector.tile_source import VectorRenderTileSource
...
class VectorRenderPlanner:
    ...
    def build_frame_items(
        ...
        for compiled_layer in compiled.vector_layers:
