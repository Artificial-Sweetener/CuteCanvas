...
from ..types import ComparisonDividerState, ComparisonOrientation, ComparisonState

if TYPE_CHECKING:
    from ..viewer import QPane


class ComparisonInteractionState(Protocol):
    """Comparison operations consumed by divider interaction."""

    def state(self) -> ComparisonState:
        """Return current comparison presentation state."""
        ...
    ...
    def set_split(
        ...
        """Apply a normalized comparison split."""
        ...
...
class CompareDividerInteraction:
    ...
    def __init__(
        ...
        *,
        qpane: QPane,
        service: ComparisonInteractionState,
    ) -> None:
    ...
    def _current_render_plan(self) -> SceneRenderPlan | None:
        ...
        if plan is not None:
            return plan
        try:
            return self._qpane.calculateRenderPlan()
