...
class MaskEditService:
    ...
    def _layer_is_empty(layer: MaskLayer | None) -> bool:
        ...
        return layer is None or layer.coverage.raster.is_null()
    ...
    def prepare_stroke_job(
        ...
        *,
        ...
        if layer is None or self._layer_is_empty(layer):
            ...
            return None
        surface_bounds = layer.coverage.raster.bounds
        ...
        width = bounded.width()
        before_slice = layer.coverage.raster.snapshot_storage_region(
    ...
    def apply_coverage_item(self, mask_id: uuid.UUID, item: CoverageItem) -> bool:
        ...
        if layer is not None:
            self._renders.invalidate_layer(layer)
        bounds_after = None if layer is None else layer.coverage.source_bounds()
