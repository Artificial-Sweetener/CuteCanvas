...
"""Focused host-facing vector editor delegation behind the CuteCanvas facade."""
...
class VectorHostFacade:
    ...
    def text_edit_state(self) -> VectorTextEditSnapshot | None:
    ...
    def selection_state(self) -> VectorSelectionSnapshot | None:
    ...
    def node_selection_state(self) -> VectorNodeSelectionSnapshot | None:
        ...
        if (
            ...
            return None
        return VectorNodeSelectionSnapshot(
            public_scene_id,
            state.layer_id,
            state.object_id,
            state.node_index,
