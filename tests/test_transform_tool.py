...
def _port(calls: list[tuple[str, object]]) -> TransformInteractionPort:
    ...
    return TransformInteractionPort(
        ...
        begin_transform=lambda operation, _point: calls.append(("begin", operation))
        or True,
        update_transform=lambda _point, modifiers: calls.append(("update", modifiers))
        or True,
        end_transform_gesture=lambda _point, modifiers: calls.append(("end", modifiers))
        or True,
